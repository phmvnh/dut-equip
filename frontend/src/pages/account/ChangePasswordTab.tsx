  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-200 overflow-hidden">
      <div className="px-6 py-4 border-b border-gray-100">
        ...
        <p className="text-xs text-gray-500 mt-0.5">Mật khẩu mới phải có ít nhất 8 ký tự</p>
      </div>
      ...
      <div className="px-6 py-5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 max-w-sm">
          ...
          <button
            type="submit"
            disabled={loading}
            className="px-5 py-2.5 rounded-xl bg-blue-100 text-blue-700 border border-blue-300 text-sm font-medium hover:bg-blue-200 disabled:opacity-60 disabled:cursor-not-allowed transition-colors duration-150 flex items-center gap-2"
          >
