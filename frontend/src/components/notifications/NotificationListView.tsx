...
const TYPE_BADGE_CLASS: Record<NotificationType, string> = {
  ...
  PROCUREMENT_SUBMITTED:  'bg-blue-100 text-blue-700',
  PROCUREMENT_APPROVED:   'bg-green-100 text-green-700',
  PROCUREMENT_REJECTED:   'bg-red-100 text-red-700',
  PROCUREMENT_COMPLETED:  'bg-emerald-100 text-emerald-700',
  DISPOSAL_SUBMITTED:     'bg-blue-100 text-blue-700',
  DISPOSAL_APPROVED:      'bg-green-100 text-green-700',
  DISPOSAL_REJECTED:      'bg-red-100 text-red-700',
  DISPOSAL_COMPLETED:     'bg-slate-100 text-slate-600',
};
